<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Data Catatan Akademik
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-th"></i>Data Master</a></li>
            <li class="active">Data Catatan Akademik</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <?php $this->view('pesan') ?>
                        <h3 class="box-title">Data Catatan Akademik</h3>
                        <form style='margin-right:5px; margin-top:0px' class='pull-right' action='<?= base_url('catatan') ?>' method='POST'>
                            ...
                            <tbody>
                                ...
                                if ($idtahun != '' && $kodekelas != '') { ?>
                                    ...
                                    foreach ($siswa->result() as $data) {
                                        $cek = $this->db->get_where('tb_catatan_akademik', array('nisn' => $data->nisn, 'id_tahun_akademik' => $idtahun, 'kode_kelas' => $kodekelas));
                                    ?>
                                        <form action="<?=base_url('catatan/simpan')?>" method="POST">
                                            <tr>
                                                ...
                                                <td><input type="text" name="catatan" class="form-control" style="width:100%; color:blue" placeholder="Tuliskan Catatan Akademik..."></td>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d->catatan ?></td>
                                                    <td align="center">
                                                        <a href="<?= base_url('catatan/hapus/' . $d->id_catatan_akademik . '/' . $idtahun . '/' . $kodekelas) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Apa anda yakin untuk hapus Data ini?')"><span class="glyphicon glyphicon-remove"></span></a>
                                                    </td>
                                                </tr>
                                    <?php }
                                        }
