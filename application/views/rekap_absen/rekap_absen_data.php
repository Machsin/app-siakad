                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($rekap_absen->result() as $data) { ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        ...
                                        <td><a class="btn btn-xs btn-success" href="<?=base_url('rekap_absen/detail/'.$data->kodejdwl)?>"><span class="glyphicon glyphicon-th"></span> Tampilkan</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
