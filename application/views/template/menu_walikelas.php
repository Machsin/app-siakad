<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview <?=$this->uri->segment(1) == 'nilai_uts'||$this->uri->segment(1) == 'capaian_belajar'||$this->uri->segment(1) == 'extrakulikuler'||$this->uri->segment(1) == 'prestasi'||$this->uri->segment(1) == 'nilai_raport'?'active menu-open':null?>">
        <a href="<?= base_url('assets/') ?>#">
        ...
        <ul class="treeview-menu">
            ...
            <li class="<?=$this->uri->segment(1) == 'craport'?'active':null?>"><a href="<?= base_url('') ?>"><i class="fa fa-circle-o"></i> Cetak Raport</a></li>
        </ul>
    </li>
</ul>