<?php
class Capaian_Belajar_Model extends CI_Model
{
    ...
    public function tampilcapaianbelajar($kode)
    {
        $query = $this->db->from('tb_nilai_sikap_semester')->where('id_nilai_sikap_semester', $kode)->get();
        return $query;
    }
}
