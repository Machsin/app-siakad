<?php
class Nilai_Raport_Model extends CI_Model
{
    ...
    public function tampilnilaisikap($kode)
    {
        $query = $this->db->from('tb_nilai_sikap')->where('kodejdwl', $kode)->get();
        return $query;
    }
    public function tampilnilaipengetahuan($kode)
    {
