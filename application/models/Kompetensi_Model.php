...
{
    public function tampildata($kelas = NULL, $kodejdwl = NULL)
    {
    ...
    public function tampilkompetensi($kode)
    {
        $query = $this->db->from('tb_kompetensi_dasar')->where('kodejdwl', $kode)->get();
        return $query;
    }
}
